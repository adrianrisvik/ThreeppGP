...
//Implementation of Physics with help from AI
...
Physics::Physics(float gravity, MC& mc)
    ...
    std::cout << "Bullet initialized with gravity: " << gravity_ << std::endl;
